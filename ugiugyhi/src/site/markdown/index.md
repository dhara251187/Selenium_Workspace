...
This is a base project created with the [Spring Web Service Maven Archetype][spring-web-service-maven-archetype], prepared to ease the development of new libraries.
...
First of all, check the [Spring Web Service Maven Archetype][spring-web-service-maven-archetype] documentation, and then edit the readme file and the Maven site descriptions about the project.
